                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 mt-4">
                            <div class="wrap">
                                ...
                                <input type="text" class="form-control focus" name="nome" placeholder="Nome" value="{{old('nome')}}">
                                @if ($errors->has('nome'))
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6 mt-4">
                            <div class="wrap">
                                ...
                                <input type="text" class="form-control focus" name="login" placeholder="Login" value="{{old('login')}}">
                                @if ($errors->has('nome'))
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 mt-4">
                            <div class="wrap">
                                ...
                                <input type="password" class="form-control focus" name="senha" placeholder="Senha" value="{{old('senha')}}">
                                @if ($errors->has('senha'))
